  ...
  return (
    <main className="relative min-h-[100dvh] mesh-warm grain">
      <div className="relative z-10 px-5 pt-10 max-w-md mx-auto">
        ...
        <h1 className="font-serif text-5xl mt-8 text-plum leading-[0.95]">Start a<br/>celebration.</h1>
        <p className="text-plum/70 mt-3">It takes a minute. No confirmation email.</p>
        ...
        <p className="mt-8 text-sm text-plum/70 text-center">
          Already have one? <Link href="/login" className="text-terracotta font-medium">Sign in</Link>
        </p>
      </div>
    </main>
  );
